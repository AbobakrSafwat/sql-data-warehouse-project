...
===============================================================================
Purpose:
    Extracts raw data from the Bronze layer, applies cleansing, standardization, 
    and business rules, and performs a full-refresh load into the Silver layer.

Key Actions:
    - Deduplicates CRM customer data.
    - Standardizes date formats, text cases, and country codes.
    - Calculates SCD Type 2 end-dates for products.
    - Imputes missing sales figures.
===============================================================================
*/
	...
	BEGIN TRY
		...
		SELECT
			...
			CASE WHEN TRIM(CNTRY) IN ('US','USA','UNITED STATES') THEN 'United States'
				 WHEN TRIM(CNTRY) IN ('DE', 'GERMAN') THEN 'Germany'
